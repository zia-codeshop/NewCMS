...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
            <div class="breadcrumb-title pr-3">Agents</div>

            <div class="ml-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.customers.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i> Add Agent</a>
                </div>
            </div>
        </div>
        ...
        <!--end breadcrumb-->
        <div class="card">
            <div class="card-header">Agents Data</div>
            <div class="card-body">
                            ...
                            @if ($agents->count())
                                @foreach ($agents as $agent)
                                    <tr>
                                        ...
                                        <td>{{ $agent->address }}</td>
                                        <td>
                                            <a href="{{ route('admin.customers.edit', $agent) }}"><i class="bx bx-edit" id="my-edit"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('admin.customers.destroy', $agent) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
